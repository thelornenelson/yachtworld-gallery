...
const main = async () => {
  ...
  const sizeCache = new _components_sizeCache__WEBPACK_IMPORTED_MODULE_6__["default"]({ id: 'yw-gallery-size-cache-v1' });
